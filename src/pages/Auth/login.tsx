    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-background text-foreground selection:bg-primary/20">
      ...
      >
        <div className="w-full max-w-md bg-card rounded-3xl p-12 shadow-2xl relative">
          ...
          <h2 className="text-4xl font-display font-bold mb-2 text-center">Welcome Back</h2>
          <p className="text-center text-muted-foreground mb-8 text-lg">Log in to your account</p>
          ...
          <form className="space-y-8" onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="relative group">
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-purple-500 via-blue-500 to-primary opacity-50 blur-lg animate-gradient-x"></div>
              <div className="relative z-10">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground transition group-focus-within:text-primary" size={20} />
                <input
                  id="password"
                  name="password-login"
                  ...
                  placeholder=" "
                  required
                  className="peer w-full rounded-2xl bg-card border border-border pl-12 pr-12 py-4 text-lg text-foreground placeholder-transparent focus:border-primary focus:ring-2 focus:ring-primary outline-none transition shadow-sm focus:shadow-primary/50"
                />
                <label
                  htmlFor="password"
                  className={`absolute left-12 cursor-text transition-all
                    ${password ? "top-1 text-sm text-primary" : "top-4.5 text-lg text-muted-foreground"}
                    peer-focus:top-1 peer-focus:text-sm peer-focus:text-primary`}
                >
                  Password
                </label>
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-primary hover:text-primary/90 transition"
